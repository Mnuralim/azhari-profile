...
const AddRiwayatPekerjaan = () => {
  ...
  const handleForm = async (e) => {
    ...
    try {
      const response = await axios.post("https://colorful-calf-helmet.cyclic.app/add-workhistory", formData);
    ...
    <section className="relative flex min-h-screen mt-10 mb-20 lg:mt-20" id="contact">
      <div className="w-full">
        <h1 className="mt-16 text-4xl font-bold text-center lg:text-5xl">
          Tambah <span className="text-indigo-500">Riwayat Pekerjaan</span>
        </h1>
