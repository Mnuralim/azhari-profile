...
const About = () => {
  return (
    <section id="about" className="relative min-h-screen p-5 mt-10 lg:px-16 flex items-center">
      <div className="relative mt-10 z-50 flex flex-col items-center justify-center lg:flex-row lg:gap-48">
