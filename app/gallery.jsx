...
const Gallery = () => {
  return (
    <section id="gallery" className="relative min-h-screen p-5 mt-10 lg:mt-20">
      <h1 className="mb-5 text-4xl font-bold text-center">Blog</h1>
      <motion.div variants={galleryContainerVariant} initial="hidden" whileInView="show" className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
        <motion.div variants={galleryVariant} className="w-full p-2 rounded-xl bg-slate-300/50">
          ...
          <div className="flex gap-4 mt-3 text-sm text-slate-700">
            <div>
          ...
          <h2 className="my-3 font-semibold text-slate-700">Transportasi Laut Buton Tengah Berdampak Positif (Doktor Azhari Effect)</h2>
        ...
        <motion.div variants={galleryVariant} className="w-full p-2 rounded-xl bg-slate-300/50">
          ...
          <h2 className="my-3 font-semibold text-slate-700">Sudah Saatnya Supir Mobil Penumpang dan Ojek Berpihak 2024</h2>
          <p className="text-sm text-slate-600">
        ...
        <motion.div variants={galleryVariant} className="w-full p-2 rounded-xl bg-slate-300/50">
          ...
          <h2 className="my-3 font-semibold text-slate-700">Kebangkitan Ekonomi Nelayan Buton Tengah</h2>
          <p className="text-sm text-slate-600">
        ...
        <motion.div variants={galleryVariant} className="w-full p-2 rounded-xl bg-slate-300/50">
          ...
          <h2 className="my-3 font-semibold text-slate-700">MENELUSURI DASAR SUDUT PANDANG CALON KUAT BUPATI BUTON TENGAH 2024</h2>
          <p className="text-sm text-slate-600">
