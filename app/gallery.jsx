...
const Gallery = () => {
  return (
    <section className="min-h-screen relative mt-10 p-5 lg:mt-20">
      <h1 className="text-center text-4xl font-bold mb-5">Blog</h1>
      <motion.div variants={galleryContainerVariant} initial="hidden" whileInView="show" className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
        <motion.div variants={galleryVariant} className="w-full rounded-xl bg-slate-300/50 p-2">
          ...
          <div className="flex gap-4 text-sm mt-3 text-slate-700">
            <div>
          ...
          <h2 className="text-slate-700 font-semibold my-3">Transportasi Laut Buton Tengah Berdampak Positif (Doktor Azhari Effect)</h2>
        ...
        <motion.div variants={galleryVariant} className="w-full  rounded-xl bg-slate-300/50 p-2">
          ...
          <h2 className="text-slate-700 font-semibold my-3">Sudah Saatnya Supir Mobil Penumpang dan Ojek Berpihak 2024</h2>
          <p className="text-slate-600 text-sm">
        ...
        <motion.div variants={galleryVariant} className="w-full  rounded-xl bg-slate-300/50 p-2">
          ...
          <h2 className="text-slate-700 font-semibold my-3">Kebangkitan Ekonomi Nelayan Buton Tengah</h2>
          <p className="text-slate-600 text-sm">
        ...
        <motion.div variants={galleryVariant} className="w-full  rounded-xl bg-slate-300/50 p-2">
          ...
          <h2 className="text-slate-700 font-semibold my-3">MENELUSURI DASAR SUDUT PANDANG CALON KUAT BUPATI BUTON TENGAH 2024</h2>
          <p className="text-slate-600 text-sm">
