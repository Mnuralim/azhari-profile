...
const IlmiahPage = () => {
  ...
  return (
    <section id="ilmiah" className="relative flex items-center min-h-screen p-5 mt-10 lg:mt-20">
      <div className="w-full">
        ...
        {activeTab == "book" ? "" : <Ilmiah ilmiah={ilmiah} />}
      </div>
    </section>
  );
};
